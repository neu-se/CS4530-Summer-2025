...
While thinking a bit about your search query can help with locating authoritative sources (adding "mdn", "docs", or just [adding profanity](https://thepost.ph/money/technology/how-to-disable-google-ai-overviews-easily/) to a search query are three of my go-to approaches), there's little question that search engine results for the kind of questions that folks leaned on Stack Overflow to answer a decade ago. If you're going to get a Google AI preview anyway, you're just as welcome to use ChatGPT.

#### Codebase navigation

In the first two individual projects, we wanted you to think about questions like "where should I add a new file to put the hooks for new friend notifications" without generative AI tools; learning to navigate a codebase from scratch and with simple and predictable tools like right-click-go-to-definition is very powerful.
...
The general theme here is "stuff that your group may not have expertise in, but that in the real world I implore you to seek out people with actual expertise in rather than just vibe your way through it."
 ...
 - AI art: to be frank, I'm opposed to the use of AI art on both an aesthetic and a philosophical level, but I will limit my reactions to maybe making an unhappy face in the final project presentation and won't grade based on it.
