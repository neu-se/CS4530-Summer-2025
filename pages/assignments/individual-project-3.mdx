...
**With the exception of tasks 1 and 5, you can _choose_ whether or not to use generative AI tools for this assignment. You will be expected to document and reflect on all the tools you use.**
...
**YOU _CANNOT_ USE GENERATIVE AI TOOLS FOR THIS TASK**
...
In a new file USER_STORY.md, give some feedback on this user story. Can you propose a better user story that might do a better job achieving these conditions of satisfaction?

### Task 2: Implement opt-out

Implement the conditions of satisfaction for the opt-out user story. Only the essential and desirable conditions are expected, and the essential ones will be given most of the weight in grading. You're not expected to implement the extension exercises — for example, it's fine if users who have opted out have to explicitly rejoin chat every time they visit a game page; that's part of condition of satisfaction 4.7, which you're not expected to implement.
