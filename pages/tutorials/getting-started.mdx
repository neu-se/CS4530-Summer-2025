...
import tall from "./getting-started/node/nvmw-finished.png";
...
4. Upon completion, you will see the below window
   ...
   <Image src={tall} alt="" style="max-width: 100%;" />
...
![image](./getting-started/vsc/useful-extensions.JPG)
...
3. Click on Install.
4. Done!
   - ![image](./getting-started/vsc/eslint-search.JPG)
