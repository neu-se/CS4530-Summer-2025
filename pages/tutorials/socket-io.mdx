...
- [What is Socket.IO](tutorials/socket-io#what-is-socketio)
  - [How Does It Work?](tutorials/socket-io#how-does-it-work)
  - [Socket.IO vs. REST APIs](tutorials/socket-io#socketio-vs-rest-apis)
  - [Example Uses](tutorials/socket-io#example-uses)
- [Using Socket.IO](tutorials/socket-io#using-socketio)
  - [Set Up a New Project](tutorials/socket-io#set-up-a-new-project)
  - [Emitting & Receiving Socket Events](tutorials/socket-io#emitting-and-receiving-socket-events)
  - [Putting It All Together](tutorials/socket-io#putting-it-all-together)
- [Useful Resources](tutorials/socket-io#useful-resources)
