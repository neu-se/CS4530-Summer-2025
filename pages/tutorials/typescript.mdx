...
*   [Types in Typescript](tutorials/typescript#types-in-typescript)
    *   [Boolean](tutorials/typescript#boolean)
    *   [Number](tutorials/typescript#number)
    *   [BigInt](tutorials/typescript#bigint)
    *   [String](tutorials/typescript#string)
    *   [Arrays](tutorials/typescript#arrays)
    *   [Tuples](tutorials/typescript#tuples)
    *   [Enums](tutorials/typescript#enums)
    *   [Any](tutorials/typescript#any)
    *   [Unknown](tutorials/typescript#unknown)
    *   [Literal](tutorials/typescript#literal)
*   [Variable declaration in typescript](tutorials/typescript#variable-declaration-in-typescript)
*   [Objects](tutorials/typescript#objects)
*   [Control Flow Statements](tutorials/typescript#control-flow-statements)
    *   [Equality vs Strict Equality](tutorials/typescript#equality-vs-strict-equality)
*   [Loops](tutorials/typescript#loops)
*   [Array Functions](tutorials/typescript#array-functions)
    *   [ForEach](tutorials/typescript#foreach)
    *   [Map](tutorials/typescript#map)
    *   [Filter](tutorials/typescript#filter)
    *   [Reduce](tutorials/typescript#reduce)
*   [Functions](tutorials/typescript#functions)
    *   [Typing the function](tutorials/typescript#typing-the-function)
    *   [Invoking the function](tutorials/typescript#invoking-the-function)
    *   [Optional and Default Parameters](tutorials/typescript#optional-and-default-parameters)
    *   [Rest Parameters](tutorials/typescript#rest-parameters)
    *   [Functions as Constructors](tutorials/typescript#functions-as-constructors)
    *   [Arrow Functions](tutorials/typescript#arrow-functions)
    *   [Function Overloads](tutorials/typescript#function-overloads)
*   [Classes](tutorials/typescript#classes)
    *   [Creating a class](tutorials/typescript#creating-an-abstract-class)
    *   [Creating an abstract class](tutorials/typescript#creating-an-abstract-class)
*   [Type Aliases](tutorials/typescript#type-aliases)
*   [Interfaces](tutorials/typescript#interfaces)
*   [Custom types](tutorials/typescript#custom-types)
*   [Generics](tutorials/typescript#generics)
*   [Modules](tutorials/typescript#modules)
*   [Object oriented programming concepts using typescript](tutorials/typescript#object-oriented-programming-concepts-using-typescript)
    *   [Inheritance](tutorials/typescript#inheritance)
    *   [Polymorphism](tutorials/typescript#polymorphism)
    *   [Abstraction](tutorials/typescript#abstraction)
    *   [Encapsulation](tutorials/typescript#encapsulation)
*   [General Guidelines](tutorials/typescript#general-guidelines)
*   [tsconfig](tutorials/typescript#tsconfig)
...
```
*   _Usage_: 
You can compare boolean values (with `==`, `===`, `||`, `&&`, and `?`), negate them (with !). You usually [should not use `==`](https://blog.webdevsimplified.com/2020-08/==-vs-===/).
...
```ts
const oneBillionOne = 1_000_000_001;
```

### BigInt

The bigint type is a [relatively recent](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/BigInt) addition to JavaScript, and not one you're likely to encounter building web applications. BigInts are distinguished by an `n` after the number, and support things like addition (`+`), subtraction (`-`), multiplication (`*`), division (`/`), and comparison (`<`). They don't play nicely
...
const c = a + b; 
const d = a < b;  // boolean
const e = 88.5n;  // A bigint literal must be an integer.ts(1353)
const f: bigint = 100n;
const g: 100n = 100n;
const h = f + 3;  // Operator '+' cannot be applied to types 'bigint' and '3'.ts(2365)
```

*   _Usage_: 
BigInt lets you work with large integers without running into rounding errors. While the `number` type can only represent whole numbers, `bigint` can hold numbers larger than 2<sup>53</sup> – 1. 

### String

Strings support [many operations](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String) and can be concatenated with the plus (`+`) operator, though [template strings](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals) are an increasingly popular way to combine strings. 
...
Some notable operatons on strings:
...
``` 
*   _Usage_: 
For the few cases where you have a value whose type you really don’t know ahead of time, don’t use any, and instead reach for the `unknown`. Like `any`, it represents any value, but TypeScript won’t let you use an unknown type until you refine it by checking what it is.
